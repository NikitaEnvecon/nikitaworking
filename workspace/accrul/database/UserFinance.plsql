...
micro_cache_id1_ user_finance_tab.company%TYPE;

micro_cache_id2_ user_finance_tab.userid%TYPE;
...
BEGIN  
   ...
   IF (userid_ = Fnd_Session_API.Get_App_Owner AND Installation_SYS.Get_Installation_Mode) THEN
...
BEGIN
   ...
   RETURN (company_ = micro_cache_value_.company);
...
BEGIN
   ...
   */
   ...
   IF (Installation_SYS.Get_Installation_Mode AND Fnd_Session_API.Get_Fnd_User = Fnd_Session_API.Get_App_Owner) THEN
      RETURN 'TRUE';
   END IF;
