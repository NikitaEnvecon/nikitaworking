...
-- Modifications 8.50 [ Move Codeparts ]
   RETURN ACCOUNT_API.Get_Cons_Accnt(company_, code_part_value_);
...
-- Modifications 8.50 [ Move Codeparts ]
   ACCOUNT_API.Get_Account_Info (description_, valid_from_, valid_until_, accounting_text_id_,
         accnt_group_, accnt_type_, process_code_, ledg_flag_, cons_company_, cons_accnt_,
...
-- Modifications 8.50 [ Move Codeparts ]
   ACCOUNT_API.Validate_Consolidation_Accnt(company_, cons_company_);
...
-- Modifications 8.50 [ Move Codeparts ]
   ACCOUNT_API.Clear_Consolidation_Account(company_);
...
-- Modifications 8.50 [ Move Codeparts ]
   RETURN ACCOUNT_API.Calculate_Accnt_For_Cons(company_, code_part_value_);
...
-- Modifications 8.50 [ Move Codeparts ]
   RETURN ACCOUNT_API.Accnt_Exist_In_Cons_Company(cons_company_, account_);
