   ...
   IF (run_crecomp_) THEN
      FOR rec_ IN get_data LOOP
         ...
         BEGIN
            ...
            --old app8 code was changed to use check_insert___ so the validations will be used.
...
IS   
   ...
   IS       
   BEGIN
      Insert_Map_Detail___(footer_connection_module_,
...
BEGIN         
   ...
   Insert_Map_Head___(footer_connection_module_,
                      ...
                      client_window_);
   -- Insert Map Detail
   Insert_Map_Detail('C1', 'FOOTER_CONNECTION_GEN_PCT.REPORT_ID' );
   Insert_Map_Detail('C2', 'FOOTER_CONNECTION_GEN_PCT.CONTRACT' );
   Insert_Map_Detail('C3', 'FOOTER_CONNECTION_GEN_PCT.FOOTER_ID' );
