...
--  160711  Kagalk  Bug 130352, Modified Comment_To_Reference() to get lu name when CUSTOM references are used.
-----------------------------------------------------------------------------
   ...
   ELSE
      ...
      IF ( NVL(tmp_,' ') != '<DUMMY>' ) THEN
         ...
         IF (validate_method_ IS NOT NULL) THEN
            ...
            END IF;
            --
            IF (NOT Dictionary_SYS.Method_Is_Installed ( package_, method_ )) THEN
...
BEGIN
   ...
   ELSE
      ...
      END IF;
      -- Bug 130352, Modified if condition
