...
#endregion
#region History
// 16-03-29  Samllk   Bug 128136 Fixed.
#endregion
	...
	public partial class dlgInterimVoucher : cDialogBoxFin
	{
		...
		public new SalBoolean FrameStartupUser()
		{
			...
			using (new SalContext(this))
			{
                ...
                lsStmt = cSessionManager.c_sDbPrefix + "Accounting_Period_API.Get_Firstdate_Nextopenperiod(" + sFormName + "nAccountingPeriod," + sFormName + "nAccountingYear," + sFormName + "dVoucherDate," + sFormName + "sPCompany," + sFormName + "nPAccYear," +
                sFormName + "sPUserGroup," + sFormName + "nPAccPeriod, '00');";
                ...
                {
                    hints.Add("Accounting_Period_API.Get_Firstdate_Nextopenperiod", System.Data.ParameterDirection.Output, System.Data.ParameterDirection.Output, System.Data.ParameterDirection.Output, System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input);
				...
				{
                    Ifs.Fnd.ApplicationForms.Int.AlertBox(Properties.Resources.TEXT_VoEn_NoOpenPeriods, Ifs.Fnd.ApplicationForms.Properties.Resources.CAPTION_Error, Ifs.Fnd.ApplicationForms.Const.CRITICAL_Ok);
					return false;
				}
		...
		public virtual SalNumber UserGroupChanged()
		{
			...
			using (new SalContext(this))
			{
                ...
                lsStmt = cSessionManager.c_sDbPrefix + "Accounting_Period_API.Get_Firstdate_Nextopenperiod(" + sFormName + "nAccountingPeriod," + sFormName + "nAccountingYear," + sFormName + "dVoucherDate," + sFormName + "sPCompany," + sFormName + "nPAccYear," + 
				sFormName + "cmbUserGroup," + sFormName + "nPAccPeriod, '00');";
