...
namespace Ifs.Application.Accrul_
{
	...
	public partial class frmUserGrpPer
	{
        ...
        private void InitializeComponent()
        {
            ...
            this.menuFrmMethods_menuOpen_GL_Period = new Ifs.Fnd.Windows.Forms.FndCommand(this.components);
            this.menuItem_Close = new Ifs.Fnd.Windows.Forms.FndToolStripMenuItem(this.components);
            this.menuFrmMethods_menuClose_GL_Period = new Ifs.Fnd.Windows.Forms.FndCommand(this.components);
            ...
            this.tblUserGroups_colsPeriodStatusDb = new Ifs.Fnd.ApplicationForms.cColumn();
            ...
            this.commandManager.Commands.Add(this.menuFrmMethods_menuOpen_GL_Period);
            this.commandManager.Commands.Add(this.menuFrmMethods_menuClose_GL_Period);
            ...
            // menuItem_Open
            // 
            this.menuItem_Open.Command = this.menuFrmMethods_menuOpen_GL_Period;
            this.menuItem_Open.Name = "menuItem_Open";
            resources.ApplyResources(this.menuItem_Open, "menuItem_Open");
            this.menuItem_Open.Text = "Open GL Period";
            // 
            // menuFrmMethods_menuOpen_GL_Period
            // 
            resources.ApplyResources(this.menuFrmMethods_menuOpen_GL_Period, "menuFrmMethods_menuOpen_GL_Period");
            this.menuFrmMethods_menuOpen_GL_Period.Name = "menuFrmMethods_menuOpen_GL_Period";
            this.menuFrmMethods_menuOpen_GL_Period.Execute += new Ifs.Fnd.Windows.Forms.FndCommandExecuteHandler(this.menuItem_Open_Execute);
            this.menuFrmMethods_menuOpen_GL_Period.Inquire += new Ifs.Fnd.Windows.Forms.FndCommandInquireHandler(this.menuItem_Open_Inquire);
            // 
            // menuItem_Close
            // 
            this.menuItem_Close.Command = this.menuFrmMethods_menuClose_GL_Period;
            ...
            // 
            // menuFrmMethods_menuClose_GL_Period
            // 
            resources.ApplyResources(this.menuFrmMethods_menuClose_GL_Period, "menuFrmMethods_menuClose_GL_Period");
            this.menuFrmMethods_menuClose_GL_Period.Name = "menuFrmMethods_menuClose_GL_Period";
            this.menuFrmMethods_menuClose_GL_Period.Execute += new Ifs.Fnd.Windows.Forms.FndCommandExecuteHandler(this.menuItem_Close_Execute);
            this.menuFrmMethods_menuClose_GL_Period.Inquire += new Ifs.Fnd.Windows.Forms.FndCommandInquireHandler(this.menuItem_Close_Inquire);
            // 
            // tsMenuItemSeparator
            // 
            ...
            this.tblUserGroups.Controls.Add(this.tblUserGroups_colsPeriodStatusDb);
        ...
        "cPer.i_sMyValue AND\r\nACCOUNTING_PERIOD =:i_hWndFrame.frmUserGrpPer.dfPeriod");
            ...
            this.tblUserGroups.Controls.SetChildIndex(this.tblUserGroups_colsPeriodStatusDb, 0);
            ...
            // 
            this.tblUserGroups_colPeriodStatus.CellType = PPJ.Runtime.Windows.CellType.Standard;
            this.tblUserGroups_colPeriodStatus.MaxLength = 20;
            this.tblUserGroups_colPeriodStatus.Name = "tblUserGroups_colPeriodStatus";
            this.tblUserGroups_colPeriodStatus.NamedProperties.Put("EnumerateMethod", "");
            ...
            // 
            // tblUserGroups_colsPeriodStatusDb
            // 
            resources.ApplyResources(this.tblUserGroups_colsPeriodStatusDb, "tblUserGroups_colsPeriodStatusDb");
            this.tblUserGroups_colsPeriodStatusDb.MaxLength = 1;
            this.tblUserGroups_colsPeriodStatusDb.Name = "tblUserGroups_colsPeriodStatusDb";
            this.tblUserGroups_colsPeriodStatusDb.NamedProperties.Put("EnumerateMethod", "");
            this.tblUserGroups_colsPeriodStatusDb.NamedProperties.Put("LovReference", "");
            this.tblUserGroups_colsPeriodStatusDb.NamedProperties.Put("SqlColumn", "PERIOD_STATUS_DB");
            this.tblUserGroups_colsPeriodStatusDb.Position = 9;
            // 
            ...
            this.tblUserGroups_colsPeriodStatusInt.Position = 10;
        ...
        protected Fnd.Windows.Forms.FndCommand menuFrmMethods_menuOpen_GL_Period;
        protected Fnd.Windows.Forms.FndCommand menuFrmMethods_menuClose_GL_Period;
        ...
        protected cColumn tblUserGroups_colsPeriodStatusDb;
	}
}
