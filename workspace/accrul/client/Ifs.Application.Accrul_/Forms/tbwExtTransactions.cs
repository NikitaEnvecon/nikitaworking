...
// 160609  Savmlk  Bug 129523, Corrected. 
#endregion
    ...
    public partial class tbwExtTransactions : cTableWindowFin
    {
        ...
        public virtual new SalBoolean AttrFetchCodePart(ref SalString sPAttr, SalNumber nRowCount)
        {
            ...
            using (new SalContext(this))
            {
                ...
                {
                    // Bug 129523, Begin
                    if ((Sal.WindowClassName(i_hWndChild[n]) == "cColumnFin") || (Sal.WindowClassName(i_hWndChild[n]) == "cColumn") || (Sal.WindowClassName(i_hWndChild[n]) == "cColumnCodePartFin"))
                    // Bug 129523, End 
                    {
