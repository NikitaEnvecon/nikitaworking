...
// 041115  Chwtlk  Bug 125437, Fixed the issue of Paste Object. Modifications done so that valid from date of the Copied Object is pasted.
// 091115  Chwtlk  Bug 125437, Modified the DataRecordToFormUser() method's PLSQL block. Modified tblPostCtrlCombDet_DataRecordToFormUserEvent().
#endregion
...
namespace Ifs.Application.Accrul_
{
	...
	public partial class frmPostingCtrlCombDet : cFormWindowFin
	{
		...
		public virtual SalNumber DataRecordToFormUser(ref SalString lsServerAttr, ref SalBoolean bMarkAsEdited)
		{
            ...
            {   // Bug 125437, Begin, Modified the third parameter.
			    if (!(DbPLSQLBlock(@"ACCOUNTING_CODE_PARTS_API.Get_Code_Part({0} OUT,{1} IN,{2} IN)",
                                                                            ...
                                                                            this.tblPostCtrlCombDet_colsCodePartName.QualifiedBindName )))
			    {
				    return false;
			    }
                // Bug 125437, End.
        ...
        public virtual SalBoolean DataRecordPrepareNew()
        {
            ...
            using (new SalContext(this))
            {
                if (((cChildTable)this.tblPostCtrlCombDet).DataRecordPrepareNew())
                {
                    if (this.bNew)
                    {
                        this.bNew = false;
                    ...
                    {
                        return Sal.ClearField(this.tblPostCtrlCombDet_coldValidFrom);
                    }
                    return true;
                }
                return false;
        ...
        private void tblPostCtrlCombDet_DataRecordToFormUserEvent(object sender, cDataSource.DataRecordToFormUserEventArgs e)
        {
            ...
            // Bug 125437, Modified the method call.
        ...
        // Bug 125437, Begin.
        private void tblPostCtrlCombDet_DataRecordPrepareNewEvent(object sender, FndReturnEventArgsSalBoolean e)
        {
            e.Handled = true;
