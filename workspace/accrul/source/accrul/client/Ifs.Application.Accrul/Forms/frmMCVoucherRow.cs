	...
	public partial class frmMCVoucherRow : cFormWindowFin
	{
        ...
        { 
            ...
            if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute)
            {
                ...
                SetFieldEdit();
                bIsPaste = false;
                this.tblVoucherRow_colsDuplicateRow.Text = "TRUE";
                e.Return = bOk;
            }
		...
		{
            if (this.tblVoucherRow_colsDuplicateRow.Text == "FALSE") 
            {
            ...
            if (this.tblVoucherRow_colsDuplicateRow.Text == "TRUE"|| Sal.IsNull(this.tblVoucherRow_colsDuplicateRow))
            {
                tblVoucherRow_colsDuplicateRow.Text = "FALSE"; 
                if (this.tblVoucherRow_colsParentCompany.Text != this.tblVoucherRow_colsCompany.Text)
                {
                    IDictionary<string, string> namedBindVariables = new Dictionary<string, string>();
                    namedBindVariables.Add("colsCompany", this.tblVoucherRow_colsCompany.QualifiedBindName);
                    namedBindVariables.Add("colsCurrencyType", this.tblVoucherRow_colsCurrencyType.QualifiedBindName);
		...
		public virtual SalNumber DataRecordNew(SalNumber nWhat)
		{
			...
			switch (nWhat)
			{
				...
				case Ifs.Fnd.ApplicationForms.Const.METHOD_Execute:
                    ...
                    if (returnValue == 1)
                    {
                        this.tblVoucherRow_colsDuplicateRow.Text = "FALSE";
                    }
                    return returnValue;
