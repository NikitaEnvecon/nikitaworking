                ...
                if (nWhat == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute)
                {
                    ...
                    if (DbPLSQLTransaction(cSessionManager.c_hSql, sStmt))
                    {
                        if (sBatch == "FALSE")
                        {
                            ...
                            DbLobReadToFile(cSessionManager.c_hSql, "DATA", "AUDIT_STORAGE", sObjid, sFileName, ref nError);
                            DbLobReadToFile(cSessionManager.c_hSql, "XML_DATA", "AUDIT_STORAGE", sObjid, sXmlFileName, ref nError);
