...
namespace Ifs.Application.Accrul
{
	...
	public partial class dlgZoomInStructure : cDialogBoxFin
	{
		...
		/// <returns></returns>
		public static SalNumber ModalDialog(Control owner, SalString p_sCompany, SalWindowHandle p_hWndInvoker, SalArray<SalBoolean> p_bVisible, ref SalArray<SalBoolean> p_bCode, SalString p_sStructColumnName)
		{
			dlgZoomInStructure dlg = DialogFactory.CreateInstance<dlgZoomInStructure>();
		...
		/// <returns></returns>
		public new static dlgZoomInStructure FromHandle(SalWindowHandle handle)
		{
			return ((dlgZoomInStructure)SalWindow.FromHandle(handle, typeof(dlgZoomInStructure)));
		}
		#endregion
		...
		// Bug 85079, Removed the function QueryX
		...
		private void dlgZoomInStructure_WindowActions(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			switch (e.ActionType)
			{
				case Sys.SAM_Create:
					this.dlgZoomInStructure_OnSAM_Create(sender, e);
					break;
			}
			#endregion
		}
		...
		private void dlgZoomInStructure_OnSAM_Create(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
