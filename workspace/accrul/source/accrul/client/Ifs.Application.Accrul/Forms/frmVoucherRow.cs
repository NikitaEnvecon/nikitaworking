        ...
        public virtual SalBoolean UM_LaunchPeriodAllocation(SalNumber p_nWhat)
        {
            ...
            switch (p_nWhat)
            {
                case Ifs.Fnd.ApplicationForms.Const.METHOD_Inquire:
                    ...
                    if (Sal.TblAnyRows(tblVoucherRow, Sys.ROW_Selected, 0) && !(DataSourceSave(Ifs.Fnd.ApplicationForms.Const.METHOD_Inquire)) && (frmEntryVoucher.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndFrame)).sSimulationVoucher == "FALSE") && Ifs.Fnd.ApplicationForms.Var.Security.IsViewAvailable(
                        "PERIOD_ALLOCATION"))
                    {
                        nRow = Sys.TBL_MinRow;
                        bAllowed = false;
                ...
                case Ifs.Fnd.ApplicationForms.Const.METHOD_Execute:
                    ...
                    if (dlgPeriodAllocation.ModalDialog(Ifs.Fnd.ApplicationForms.Int.Explorer.ExplorerForm, frmEntryVoucher.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndFrame)).dfsCompany.Text, frmEntryVoucher.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndFrame)).dfnAccountingPeriod.Number))
                    {
                        nRow = Sys.TBL_MinRow;
