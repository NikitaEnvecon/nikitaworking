...
namespace Ifs.Application.Accrul
{
	...
	/// <summary>
	/// </summary>
	public partial class cWizardDialogBoxFin : cWizardDialogBox
	{
		...
		public cWizardDialogBoxFin(ISalWindow derived)
		{
					...
					if (sThirdCurrencyCode != Ifs.Fnd.ApplicationForms.Const.strNULL) 
					{
						...
						// RUNTIME_CORRECTION: Used i_hWndSelf instead of i_hWndFrame since that doesn't refer to correct object cTableWindowFin
                            bOk = DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN\r\n &AO.Currency_Rate_API.Get_Parallel_Currency_Rate(\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.i_nFinThirdCurrencyRate INOUT, \r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.i_nFinThirdConversionFactor INOUT,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.i_lsFinThirdInverted INOUT,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sFinCompany IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sFinCurrencyCode IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.dFinDate IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sParallelCurrencyRateType IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.i_sFinParallelBaseType IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sFinBaseCurrencyCode IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sFinThirdCurrencyCode IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sNullValue IN,\r\n" +
                                " :i_hWndSelf.cWizardDialogBoxFin.sNullValue IN\r\n" +
                                ");\r\n" +
                            " \r\n SELECT " + cSessionManager.c_sDbPrefix + "Currency_Code_API.Get_Currency_Rounding(:i_hWndSelf.cWizardDialogBoxFin.sFinCompany, :i_hWndSelf.cWizardDialogBoxFin.sFinThirdCurrencyCode)\r\n" +
                            "INTO :i_hWndSelf.cWizardDialogBoxFin.i_nFinTransAmountRound FROM DUAL;\r\n END;");
		...
		private void cWizardDialogBoxFin_WindowActions(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			switch (e.ActionType)
			{
				case Const.PAM_CallChanged:
					this.cWizardDialogBoxFin_OnPAM_CallChanged(sender, e);
					break;
				
				case Const.PAM_ChangedChildText:
					this.cWizardDialogBoxFin_OnPAM_ChangedChildText(sender, e);
					break;
				
				case Const.PAM_GetAndSetDefaultCompany:
					this.cWizardDialogBoxFin_OnPAM_GetAndSetDefaultCompany(sender, e);
					break;
								
				case Ifs.Fnd.ApplicationForms.Const.PM_UserProfileChanged:
					this.cWizardDialogBoxFin_OnPM_UserProfileChanged(sender, e);
					break;
				
				case Sys.SAM_CreateComplete:
					this.cWizardDialogBoxFin_OnSAM_CreateComplete(sender, e);
					break;
				
				case Const.PAM_ChangeCompany:
					this.cWizardDialogBoxFin_OnPAM_ChangeCompany(sender, e);
					break;
				
				case Const.PAM_DisableUnusedCodeParts:
					this.cWizardDialogBoxFin_OnPAM_DisableUnusedCodeParts(sender, e);
					break;
			}
			#endregion
		}
		...
		private void cWizardDialogBoxFin_OnPAM_CallChanged(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cWizardDialogBoxFin_OnPAM_ChangedChildText(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cWizardDialogBoxFin_OnPAM_GetAndSetDefaultCompany(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cWizardDialogBoxFin_OnPM_UserProfileChanged(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cWizardDialogBoxFin_OnSAM_CreateComplete(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
			...
			this.SetCompany(this.i_sCompany);
		...
		/// </summary>
		/// <param name="message"></param>
		private void cWizardDialogBoxFin_OnPAM_ChangeCompany(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
			switch (Sys.wParam)
		...
		/// </summary>
		/// <param name="message"></param>
		private void cWizardDialogBoxFin_OnPAM_DisableUnusedCodeParts(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWizardDialogBoxFin to type cDataSource.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cDataSource(cWizardDialogBoxFin self)
		{
			return self._cDataSource;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWizardDialogBoxFin to type cSessionManager.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cSessionManager(cWizardDialogBoxFin self)
		{
			return ((cSessionManager)self._cDataSource);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWizardDialogBoxFin to type cWindowTranslation.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cWindowTranslation(cWizardDialogBoxFin self)
		{
			return ((cWindowTranslation)self._cDataSource);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWizardDialogBoxFin to type cPageList.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cPageList(cWizardDialogBoxFin self)
		{
			return self._cPageList;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWizardDialogBoxFin to type cFinlibServices.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cFinlibServices(cWizardDialogBoxFin self)
		{
			return self._cFinlibServices;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cDataSource to type cWizardDialogBoxFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cWizardDialogBoxFin(cDataSource super)
		{
			return ((cWizardDialogBoxFin)super._derived);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cSessionManager to type cWizardDialogBoxFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cWizardDialogBoxFin(cSessionManager super)
		{
			return ((cWizardDialogBoxFin)((cDataSource)super._derived));
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWindowTranslation to type cWizardDialogBoxFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cWizardDialogBoxFin(cWindowTranslation super)
		{
			return ((cWizardDialogBoxFin)((cDataSource)super._derived));
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cPageList to type cWizardDialogBoxFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cWizardDialogBoxFin(cPageList super)
		{
			return ((cWizardDialogBoxFin)super._derived);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cFinlibServices to type cWizardDialogBoxFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cWizardDialogBoxFin(cFinlibServices super)
		{
			return ((cWizardDialogBoxFin)super._derived);
		}
		#endregion
		...
		/// <returns></returns>
		public new static cWizardDialogBoxFin FromHandle(SalWindowHandle handle)
		{
			return ((cWizardDialogBoxFin)SalWindow.FromHandle(handle, typeof(cWizardDialogBoxFin)));
		}
		#endregion
