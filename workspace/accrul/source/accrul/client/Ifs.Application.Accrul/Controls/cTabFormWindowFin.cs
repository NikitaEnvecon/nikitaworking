...
namespace Ifs.Application.Accrul
{
	...
	/// <summary>
	/// </summary>
	public partial class cTabFormWindowFin : cTabFormWindow
	{
		...
		public cTabFormWindowFin(ISalWindow derived)
		{
			...
			using (new SalContext(this))
			{
				...
				else
				{
					...
					using(SignatureHints hints = SignatureHints.NewContext())
					{
					    ...
					    // RUNTIME_CORRECTION: Used i_hWndSelf instead of i_hWndFrame since that doesn't refer to correct object cTabFormWindowFin
					    bOk = DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN\r\n " + cSessionManager.c_sDbPrefix + "Currency_Rate_API.Fetch_Currency_Rate_Base(\r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.i_nFinConversionFactor, \r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.i_nFinCurrencyRate,\r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.i_lsFinInverted,\r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.sFinCompany,\r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.sFinCurrencyCode,\r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.sFinBaseCurrencyCode,\r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.sFinCurrencyType, \r\n" +
					    	" :i_hWndSelf.cTabFormWindowFin.dFinDate,\r\n" +
					    	" 'DUMMY');\r\n SELECT " + cSessionManager.c_sDbPrefix + "Currency_Code_API.Get_Currency_Rounding(:i_hWndSelf.cTabFormWindowFin.sFinCompany, :i_hWndSelf.cTabFormWindowFin.sFinCurrencyCode),\r\n " + cSessionManager.c_sDbPrefix + "Currency_Code_API.Get_Currency_Rounding(:i_hWndSelf.cTabFormWindowFin.sFinCompany, :i_hWndSelf.cTabFormWindowFin.sFinBaseCurrencyCode)\r\n" +
					    	" INTO :i_hWndSelf.cTabFormWindowFin.i_nFinTransRound, :i_hWndSelf.cTabFormWindowFin.i_nFinBaseRound FROM DUAL;\r\n END;");
					}
					if (bOk) 
					{
				...
				else
				{
					...
					if (Ifs.Fnd.ApplicationForms.Var.Security.IsMethodAvailable("CURRENCY_CODE_API.Get_No_Of_Decimals_In_Rate_")) 
					{
						...
						bOk = DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN\r\n " + cSessionManager.c_sDbPrefix + "CURRENCY_CODE_API.Get_No_Of_Decimals_In_Rate_(\r\n" +
							" :i_hWndSelf.cTabFormWindowFin.i_nFinRound, \r\n" +
							" :i_hWndSelf.cTabFormWindowFin.sFinCompany,\r\n" +
							" :i_hWndSelf.cTabFormWindowFin.sFinCurrencyCode\r\n" +
							");  \r\n END;");
						}
					...
					if (sThirdCurrencyCode != Ifs.Fnd.ApplicationForms.Const.strNULL) 
					{
						...
						using(SignatureHints hints = SignatureHints.NewContext())
						{
                            ...
                            bOk = DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN\r\n &AO.Currency_Rate_API.Get_Parallel_Currency_Rate(\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.i_nFinThirdCurrencyRate INOUT, \r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.i_nFinThirdConversionFactor INOUT,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.i_lsFinThirdInverted INOUT,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sFinCompany IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sFinCurrencyCode IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.dFinDate IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sParallelCurrencyRateType IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.i_sFinParallelBaseType IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sFinBaseCurrencyCode IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sFinThirdCurrencyCode IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sFinIsBaseEMU IN,\r\n" +
                                " :i_hWndSelf.cTabFormWindowFin.sFinIsThirdEMU IN\r\n" +
                                ");\r\n" +
                                "\r\n :i_hWndSelf.cTabFormWindowFin.i_nFinTransAmountRound := &AO.Currency_Code_API.Get_Currency_Rounding(:i_hWndSelf.cTabFormWindowFin.sFinCompany IN, :i_hWndSelf.cTabFormWindowFin.sFinThirdCurrencyCode IN);\r\n" +
                                " END;\r\n");
				...
				else
				{
					...
					if (sThirdCurrencyCode != Ifs.Fnd.ApplicationForms.Const.strNULL) 
					{
						if (Ifs.Fnd.ApplicationForms.Var.Security.IsMethodAvailable("CURRENCY_CODE_API.Get_No_Of_Decimals_In_Rate_")) 
						{
							...
							// RUNTIME_CORRECTION: Used i_hWndSelf instead of i_hWndFrame since that doesn't refer to correct object cTabFormWindowFin
							bOk = DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN\r\n " + cSessionManager.c_sDbPrefix + "CURRENCY_CODE_API.Get_No_Of_Decimals_In_Rate_(\r\n" +
								" :i_hWndSelf.cTabFormWindowFin.i_nFinThirdRound, \r\n" +
								" :i_hWndSelf.cTabFormWindowFin.sFinCompany,\r\n" +
								" :i_hWndSelf.cTabFormWindowFin.sFinThirdCurrencyCode\r\n" +
								");  \r\n END;");
							}
						}
					}
		...
		private void cTabFormWindowFin_WindowActions(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			switch (e.ActionType)
			{
				case Const.PAM_CallChanged:
					this.cTabFormWindowFin_OnPAM_CallChanged(sender, e);
					break;
				case Const.PAM_ChangedChildText:
					this.cTabFormWindowFin_OnPAM_ChangedChildText(sender, e);
					break;
				
				case Const.PAM_GetAndSetDefaultCompany:
					this.cTabFormWindowFin_OnPAM_GetAndSetDefaultCompany(sender, e);
					break;
				...
				case Ifs.Fnd.ApplicationForms.Const.PM_UserProfileChanged:
					this.cTabFormWindowFin_OnPM_UserProfileChanged(sender, e);
					break;
				
				// modifications of Finance 8.5
				
				case Const.PAM_ChangeCompany:
					this.cTabFormWindowFin_OnPAM_ChangeCompany(sender, e);
					break;
				
				case Sys.SAM_CreateComplete:
					this.cTabFormWindowFin_OnSAM_CreateComplete(sender, e);
					break;
			}
			#endregion
		}
		...
		private void cTabFormWindowFin_OnPAM_CallChanged(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cTabFormWindowFin_OnPAM_ChangedChildText(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cTabFormWindowFin_OnPAM_GetAndSetDefaultCompany(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cTabFormWindowFin_OnPM_UserProfileChanged(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void cTabFormWindowFin_OnPAM_ChangeCompany(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
			switch (Sys.wParam)
		...
		/// </summary>
		/// <param name="message"></param>
		private void cTabFormWindowFin_OnSAM_CreateComplete(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cTabFormWindowFin to type cDataSource.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cDataSource(cTabFormWindowFin self)
		{
			return self._cDataSource;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cTabFormWindowFin to type cSessionManager.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cSessionManager(cTabFormWindowFin self)
		{
			return ((cSessionManager)self._cDataSource);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cTabFormWindowFin to type cWindowTranslation.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cWindowTranslation(cTabFormWindowFin self)
		{
			return ((cWindowTranslation)self._cDataSource);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cTabFormWindowFin to type SalToolTipManager.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator SalToolTipManager(cTabFormWindowFin self)
		{
			return self._SalToolTipManager;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cTabFormWindowFin to type cFinlibServices.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cFinlibServices(cTabFormWindowFin self)
		{
			return self._cFinlibServices;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cDataSource to type cTabFormWindowFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cTabFormWindowFin(cDataSource super)
		{
			return ((cTabFormWindowFin)super._derived);
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cSessionManager to type cTabFormWindowFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cTabFormWindowFin(cSessionManager super)
		{
			return ((cTabFormWindowFin)((cDataSource)super._derived));
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cWindowTranslation to type cTabFormWindowFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cTabFormWindowFin(cWindowTranslation super)
		{
			return ((cTabFormWindowFin)((cDataSource)super._derived));
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type SalToolTipManager to type cTabFormWindowFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cTabFormWindowFin(SalToolTipManager super)
		{
			return ((cTabFormWindowFin)((cDataSource)super._derived));
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cFinlibServices to type cTabFormWindowFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cTabFormWindowFin(cFinlibServices super)
		{
			return ((cTabFormWindowFin)super._derived);
		}
		#endregion
		...
		/// <returns></returns>
		public new static cTabFormWindowFin FromHandle(SalWindowHandle handle)
		{
			return ((cTabFormWindowFin)SalWindow.FromHandle(handle, typeof(cTabFormWindowFin)));
		}
		#endregion
