		...
		public virtual SalBoolean cSetCurrencyWindowText()
		{
			...
			using (new SalContext(this))
			{
				...
				else
				{
					...
					if (((cColumnFinEuro.c_sDescription == Ifs.Fnd.ApplicationForms.Const.strNULL) && (cColumnFinEuro.c_sCompany != cColumnFinEuro.c_sPrevCompany)) || (cColumnFinEuro.c_sCompany != cColumnFinEuro.c_sPrevCompany)) 
					{
						...
						cColumnFinEuro.c_sPrevCompany = cColumnFinEuro.c_sCompany;
					}
					cColumnFinEuro.c_sLabel = __sOldLabel.Replace(a, 3, cColumnFinEuro.c_sDescription);
					if (cColumnFinEuro.c_sDescription == Ifs.Fnd.ApplicationForms.Const.strNULL) 
					{
