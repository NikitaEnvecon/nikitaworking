...
//  160114  Savmlk  Bug 126734, Fixed.
#endregion
...
namespace Ifs.Application.Accrul
{
    ...
    public partial class tbwAccountOverview : cTableWindowFin
    {
        ...
        public virtual SalNumber EnableDisableGroconInfo()
        {
            ...
            {
                Sal.EnableWindowAndLabel(colsKeepRepCurrency);
                Sal.EnableWindowAndLabel(colsKeepReportingEntity);
                Sal.EnableWindowAndLabel(colsExcludeCurrTrans);               
            }
            else
            {
                Sal.DisableWindowAndLabel(colsKeepRepCurrency);
                Sal.DisableWindowAndLabel(colsKeepReportingEntity);
                Sal.DisableWindowAndLabel(colsExcludeCurrTrans);                
            }
        ...
        protected virtual void GetReportedBalancesExist()
        {
            ...
            {
                DbPLSQLBlock(":i_hWndFrame.tbwAccountOverview.sRepBalExist := &AO.Reported_Balances_Details_API.Rep_Bal_Exist(:i_hWndFrame.tbwAccountOverview.i_sCompany IN ,:i_hWndFrame.tbwAccountOverview.colsAccount IN);");
            }
            #endregion
        }
        ...
        private void tbwAccountOverview_OnPM_DataRecordDuplicate(object sender, WindowActionsEventArgs e)
        {
            ...
            if (Sal.SendClassMessage(Ifs.Fnd.ApplicationForms.Const.PM_DataRecordDuplicate, Sys.wParam, Sys.lParam))
            {
                ...
                if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute)
                {
                    ...
                    //Bug 126734, Begin - Removed the call to DataItemValidate of colsAccountType.
                    //Bug 126734, End
        ...
        private void tableWindow_colsKeepRepCurrency_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Sys.SAM_AnyEdit:
                    this.colsKeepRepCurrency_OnSAM_AnyEdit(sender, e);
                    break;
            }
            #endregion
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void colsKeepRepCurrency_OnSAM_AnyEdit(object sender, WindowActionsEventArgs e)
        {
            #region Local Variables
            ...
            if (Sal.SendClassMessage(Sys.SAM_AnyEdit, Sys.wParam, Sys.lParam))
            {
                ...
                if (sRepBalExist == "TRUE")
                {
                    ...
                    {
                        if (colsKeepRepCurrency.Text == "TRUE")
                        {
                            colsKeepRepCurrency.Clear();
                        }
                        else
                        {
                            colsKeepRepCurrency.Text = "TRUE";
                        }
                        e.Return = false;
                        return;
                    }
        ...
        private void tableWindow_colsKeepReportingEntity_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Sys.SAM_AnyEdit:
                    this.colsKeepReportingEntity_OnSAM_AnyEdit(sender, e);
                    break;
            }
            #endregion
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void colsKeepReportingEntity_OnSAM_AnyEdit(object sender, WindowActionsEventArgs e)
        {
            #region Local Variables
            SalNumber nChoice = Sys.NUMBER_Null;
            #endregion
            ...
            if (Sal.SendClassMessage(Sys.SAM_AnyEdit, Sys.wParam, Sys.lParam))
            {
                ...
                if (sRepBalExist == "TRUE")
                {
                    ...
                    {
                        if (colsKeepReportingEntity.Text == "TRUE")
                        {
                            colsKeepReportingEntity.Clear();
                        }
                        else
                        {
                            colsKeepReportingEntity.Text = "TRUE";
                        }
                        e.Return = false;
                        return;
                    }
