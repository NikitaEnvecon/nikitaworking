...
namespace Ifs.Application.Accrul_
{
	...
	/// <summary>
	/// </summary>
    public partial class frmExternalFileTemplateOut : cFormWindow
    {
        ...
        /// Default Constructor.
        /// </summary>
        public frmExternalFileTemplateOut()
        {
        ...
        /// <returns></returns>
        public new static frmExternalFileTemplateOut FromHandle(SalWindowHandle handle)
        {
            return ((frmExternalFileTemplateOut)SalWindow.FromHandle(handle, typeof(frmExternalFileTemplateOut)));
        }
        #endregion
        ...
        public virtual SalBoolean IsThereAnyLines()
        {
            ...
            using (new SalContext(this))
            {
                ...
                if (!(bLinesCountFetched))
                {
                    ...
                    {
                        hints.Add("Out_Ext_File_Template_Dir_API.Check_Rec_Exist", System.Data.ParameterDirection.Input);
                        if (!(DbPLSQLBlock(cSessionManager.c_hSql, ":i_hWndFrame.frmExternalFileTemplateIn.sLineFound :=  " + cSessionManager.c_sDbPrefix + "Out_Ext_File_Template_Dir_API.Check_Rec_Exist(\r\n" +
        ...
        private void frmExternalFileTemplateOut_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew:
                    this.frmExternalFileTemplateOut_OnPM_DataRecordNew(sender, e);
                    break;

                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordRemove:
                    this.frmExternalFileTemplateOut_OnPM_DataRecordRemove(sender, e);
                    break;

                // Bug 73500, Begin

                case Ifs.Fnd.ApplicationForms.Const.PM_DataSourceSave:
                    this.frmExternalFileTemplateOut_OnPM_DataSourceSave(sender, e);
                    break;
        ...
        private void frmExternalFileTemplateOut_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmExternalFileTemplateOut_OnPM_DataRecordRemove(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Inquire)
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmExternalFileTemplateOut_OnPM_DataSourceSave(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
        ...
        private void dfsFileName_OnPM_DataItemValidate(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            if (((bool)(((SalString)this.dfsFileName.Text).Length + ((SalString)this.dfsOutputFilePath.Text).Length > 258)) || ((bool)(((SalString)this.dfsFileName.Text).Length + ((SalString)this.dfsOutputFilePathServer.Text).Length > 258)))
            {
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An <see ref="PPJ.Runtime.WindowActionsEventArgs"/> that contains the event data.</param>
        private void cmbNameOption_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Ifs.Fnd.ApplicationForms.Const.PM_DataItemQueryEnabled:
                    this.cmbNameOption_OnPM_DataItemQueryEnabled(sender, e);
                    break;
            }
            #endregion
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void cmbNameOption_OnPM_DataItemQueryEnabled(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            // Bug 71319, Begin.
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An <see ref="PPJ.Runtime.WindowActionsEventArgs"/> that contains the event data.</param>
        private void dfsOutputFilePath_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                ...
                case Ifs.Fnd.ApplicationForms.Const.PM_DataItemValidate:
                    this.dfsOutputFilePath_OnPM_DataItemValidate(sender, e);
                    break;
        ...
        /// </summary>
        /// <param name="message"></param>
        private void dfsOutputFilePath_OnPM_DataItemValidate(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            if (((SalString)this.dfsFileName.Text).Length + ((SalString)this.dfsOutputFilePath.Text).Length > 258)
            {
                Ifs.Fnd.ApplicationForms.Int.AlertBox(Ifs.Application.Accrul.Properties.Resources.TEXT_MaximumLengthFileName2, Ifs.Fnd.ApplicationForms.Properties.Resources.CAPTION_Information, Ifs.Fnd.ApplicationForms.Const.INFO_Ok);
                e.Return = false;
                return;
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An <see ref="PPJ.Runtime.WindowActionsEventArgs"/> that contains the event data.</param>
        private void dfsOutputFilePathServer_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                ...
                case Ifs.Fnd.ApplicationForms.Const.PM_DataItemValidate:
                    this.dfsOutputFilePathServer_OnPM_DataItemValidate(sender, e);
                    break;
        ...
        /// </summary>
        /// <param name="message"></param>
        private void dfsOutputFilePathServer_OnPM_DataItemValidate(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            if (((SalString)this.dfsFileName.Text).Length + ((SalString)this.dfsOutputFilePathServer.Text).Length > 258)
            {
                Ifs.Fnd.ApplicationForms.Int.AlertBox(Ifs.Application.Accrul.Properties.Resources.TEXT_MaximumLengthFileName2, Ifs.Fnd.ApplicationForms.Properties.Resources.CAPTION_Information, Ifs.Fnd.ApplicationForms.Const.INFO_Ok);
                e.Return = false;
                return;
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An <see ref="PPJ.Runtime.WindowActionsEventArgs"/> that contains the event data.</param>
        private void dfsNumberOutFillValue_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Ifs.Fnd.ApplicationForms.Const.PM_DataItemQueryEnabled:
                    this.dfsNumberOutFillValue_OnPM_DataItemQueryEnabled(sender, e);
                    break;
            }
            #endregion
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void dfsNumberOutFillValue_OnPM_DataItemQueryEnabled(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            // Bug 71319, Begin.
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An <see ref="PPJ.Runtime.WindowActionsEventArgs"/> that contains the event data.</param>
        private void cbOverwriteFile_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Ifs.Fnd.ApplicationForms.Const.PM_DataItemQueryEnabled:
                    this.cbOverwriteFile_OnPM_DataItemQueryEnabled(sender, e);
                    break;
            }
            #endregion
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void cbOverwriteFile_OnPM_DataItemQueryEnabled(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            // Bug 71319, Begin.
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An <see ref="PPJ.Runtime.WindowActionsEventArgs"/> that contains the event data.</param>
        private void cbCreateHeader_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Ifs.Fnd.ApplicationForms.Const.PM_DataItemQueryEnabled:
                    this.cbCreateHeader_OnPM_DataItemQueryEnabled(sender, e);
                    break;
            }
            #endregion
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void cbCreateHeader_OnPM_DataItemQueryEnabled(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            // Bug 71319, Begin.
        ...
        private void cbOverwriteFile_CheckedChanged(object sender, EventArgs e)
        {
