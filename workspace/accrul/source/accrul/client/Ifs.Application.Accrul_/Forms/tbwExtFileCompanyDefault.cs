...
namespace Ifs.Application.Accrul_
{
	...
	/// <summary>
	/// </summary>
    [FndWindowRegistration("EXT_FILE_COMPANY_DEFAULT", "ExtFileCompanyDefault", FndWindowRegistrationFlags.HomePage)]
    public partial class tbwExtFileCompanyDefault : cTableWindowFin
    {
        ...
        /// Default Constructor.
        /// </summary>
        public tbwExtFileCompanyDefault()
        {
        ...
        /// <returns></returns>
        public new static tbwExtFileCompanyDefault FromHandle(SalWindowHandle handle)
        {
            return ((tbwExtFileCompanyDefault)SalWindow.FromHandle(handle, typeof(tbwExtFileCompanyDefault)));
        }
        #endregion
