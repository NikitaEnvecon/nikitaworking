...
namespace Ifs.Application.Accrul_
{
	...
	/// <summary>
	/// </summary>
	public class cRadioListBoxResizableFin : VisRadioListBox, cResize.LateBind
	{
		...
		/// Default Constructor.
		/// </summary>
		public cRadioListBoxResizableFin()
		{
		...
		public cRadioListBoxResizableFin(ISalWindow derived)
		{
		...
		{
			// 
			// cRadioListBoxResizableFin
			// 
			this.Name = "cRadioListBoxResizableFin";
		...
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cRadioListBoxResizableFin to type cResize.
		/// </summary>
		/// <param name="self"></param>
		/// <returns></returns>
		public static implicit operator cResize(cRadioListBoxResizableFin self)
		{
			return self._cResize;
		}
		
		/// <summary>
		/// Multiple Inheritance: Cast operator from type cResize to type cRadioListBoxResizableFin.
		/// </summary>
		/// <param name="super"></param>
		/// <returns></returns>
		public static implicit operator cRadioListBoxResizableFin(cResize super)
		{
			return ((cRadioListBoxResizableFin)super._derived);
		}
		#endregion
		...
		/// <returns></returns>
		public static cRadioListBoxResizableFin FromHandle(SalWindowHandle handle)
		{
			return ((cRadioListBoxResizableFin)SalWindow.FromHandle(handle, typeof(cRadioListBoxResizableFin)));
		}
		#endregion
