...
-- Bug Id 123238 Begin
PROCEDURE Update_No_Codepart_Tmp___ (company_             IN VARCHAR2, 
									          no_codepart_val_rec_ IN ACCOUNTING_CODESTR_API.CODESTRREC )
IS
BEGIN   
   DELETE POST_CTRL_NO_CODEPART_VAL_TMP;
   
   INSERT INTO POST_CTRL_NO_CODEPART_VAL_TMP
   VALUES(company_, 
		    no_codepart_val_rec_.posting_type,
	       no_codepart_val_rec_.function_group,  
	       no_codepart_val_rec_.code_a,
          no_codepart_val_rec_.code_b,
          no_codepart_val_rec_.code_c,
          no_codepart_val_rec_.code_d,
          no_codepart_val_rec_.code_e,
          no_codepart_val_rec_.code_f,
          no_codepart_val_rec_.code_g,
          no_codepart_val_rec_.code_h,
          no_codepart_val_rec_.code_i,
          no_codepart_val_rec_.code_j);

END Update_No_Codepart_Tmp___;
...
BEGIN
   ...
   FOR mr_ IN pct_master LOOP
      ...
      IF (ASCII(mr_.code_part) BETWEEN 65 AND 74) THEN
         ...
         Accounting_Codestr_API.Set_Code_Part_Val_In_Rec(crec_,
                                                         ...
                                                         value_);
        -- Bug 123238, Begin
        -- Set no_code_part_value for the codeparts
		 
		  Accounting_Codestr_API.Set_Code_Part_Val_In_Rec( no_codepart_val_rec_,
                                                          mr_.code_part,
                                                          NVL( no_code_part_value_, 'FALSE'));
	     -- Bug 123238, End
   ...
   -- Bug 123238, Begin                 
   no_codepart_val_rec_.posting_type := posting_type_;
   IF ( codestr_compl_req_ = 'TRUE')THEN
      Update_No_Codepart_Tmp___( company_, no_codepart_val_rec_);
   END IF;
   -- Bug 123238, End
