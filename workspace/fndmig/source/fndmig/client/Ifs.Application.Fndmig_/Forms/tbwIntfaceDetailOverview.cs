...
namespace Ifs.Application.Fndmig_
{
	...
	/// <summary>
	/// </summary>
    public partial class tbwIntfaceDetailOverview : cTableWindow
    {
        ...
        /// Default Constructor.
        /// </summary>
        public tbwIntfaceDetailOverview()
        {
        ...
        /// <returns></returns>
        public new static tbwIntfaceDetailOverview FromHandle(SalWindowHandle handle)
        {
            return ((tbwIntfaceDetailOverview)SalWindow.FromHandle(handle, typeof(tbwIntfaceDetailOverview)));
        }
        #endregion
