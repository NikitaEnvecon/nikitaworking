...
namespace Ifs.Application.Fndmig_
{
    ...
    [FndDynamicTabPage("frmIntfaceHeader.picTab", "DETAILFILE", "tbwIntfaceDetail", "TAB_NAME_DetailFile", 0)]
    public partial class tbwIntfaceDetail : cTableWindow
    {
        ...
        /// <returns></returns>
        public new static tbwIntfaceDetail FromHandle(SalWindowHandle handle)
        {
            return ((tbwIntfaceDetail)SalWindow.FromHandle(handle, typeof(tbwIntfaceDetail)));
        }
        #endregion
